# BUILD_STATUS — TenzorPipe 0.1.4

Status: **release compiled and independently verified** for the tested scope.
Verification timestamp: 2026-09-16T07:00:01.038900+00:00.
...
Binary SHA-256: `95163cf9b2fd5e0ac2a5431715fe153e53afeff5526024a090523f126eaac0dc`.
...
| `cargo test --all-targets --locked` | PASS; 9 tests |
| `cargo clippy --all-targets --locked -- -D warnings` | PASS |
| `cargo deny check licenses` | PASS; 133 dependency packages inventoried |
| Real-media / Python matrix | PASS; 15 cases |
...
- MP4 and WAV only. WebM, AV1, VP9, FLAC, MP3, HEVC and other codecs/containers are not claimed. Fragmented MP4, arbitrary VFR, rotation and complex edits are not independently verified.
...
- Each video picture is still resized before epoch selection. The video path dominates the remaining runtime. No general speed advantage over FFmpeg is demonstrated.
